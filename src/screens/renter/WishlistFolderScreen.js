      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        {items.length === 0 ? (
          <View style={styles.empty}>
            <Ionicons name="heart-outline" size={40} color={theme.colors.hint} />
            <Text style={[styles.emptyTitle, { color: theme.colors.textPrimary }]}>No saved items</Text>
            <Text style={[styles.emptySubtitle, { color: theme.colors.textSecondary }]}>Save items to this wishlist to see them here.</Text>
          </View>
        ) : (
