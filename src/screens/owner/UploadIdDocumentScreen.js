      ...
      <View style={[styles.uploadCard, { backgroundColor: theme.colors.white }]}>
        ...
        {idImage ? (
          <View style={styles.imagePreviewContainer}>
            <Image source={{ uri: idImage }} style={styles.imagePreview} resizeMode="cover" />
            <TouchableOpacity
        ...
        <View style={styles.successModalOverlay}>
          <View style={[styles.successModalContent, { backgroundColor: theme.colors.white }]}>
            ...
            <Text style={[styles.successModalMessage, { color: theme.colors.textSecondary }]}>
              Your ID document has been uploaded successfully. We'll review it and notify you once verified.
            </Text>
            <TouchableOpacity
...
export default UploadIdDocumentScreen;
