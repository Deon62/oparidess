...
const UploadDrivingLicenseScreen = () => {
  ...
  const handleUpload = async () => {
    if (!dlImage) {
      Alert.alert('Error', 'Please upload a driving license document');
      return;
    }
    ...
    try {
      ...
      // formData.append('dl_document', {
      //   uri: dlImage,
      //   type: 'image/jpeg',
      //   name: 'dl_document.jpg',
      // });
      ...
      <View style={[styles.infoCard, { backgroundColor: theme.colors.white }]}>
        ...
        <View style={styles.infoTextContainer}>
          ...
          <Text style={[styles.infoText, { color: theme.colors.textSecondary }]}>
            • Ensure the license is clear and all text is visible{'\n'}
            • Use good lighting when taking the photo{'\n'}
            • Make sure the entire license is within the frame{'\n'}
      ...
      <View style={[styles.uploadCard, { backgroundColor: theme.colors.white }]}>
        ...
        {dlImage ? (
          <View style={styles.imagePreviewContainer}>
            <Image source={{ uri: dlImage }} style={styles.imagePreview} resizeMode="cover" />
            <TouchableOpacity
        ...
        <View style={styles.successModalOverlay}>
          <View style={[styles.successModalContent, { backgroundColor: theme.colors.white }]}>
            ...
            <Text style={[styles.successModalMessage, { color: theme.colors.textSecondary }]}>
              Your driving license has been uploaded successfully. We'll review it and notify you once verified.
            </Text>
            <TouchableOpacity
